...
liff.init(function(data){initializeApp(data);});});$(function(){$('#checklogin_form_submit').click(function(e){var status=true;var email=$('#email').val();var password=$('#password').val();if(email==''){status=false;}else if(password==''){status=false;}
