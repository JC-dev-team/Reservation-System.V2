;$('#displayName').html('吳哲御'+'('+'吳哲御'+')');$('#displayPhone').html('0912013245');function reservation_submit(){if('7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'==null||'7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'==''){Notiflix.Loading.Hourglass('訂位處理中...');reservation_form_submit()}else if('7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'!=null&&'7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'!=''){Notiflix.Loading.Hourglass('訂位處理中...');document.getElementById("reservation_form").action="/softwayliving/insert_bk/";document.getElementById("reservation_form").submit();}
