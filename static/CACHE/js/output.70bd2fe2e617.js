;$('#displayName').html('Yy'+'('+'name'+')');$('#displayPhone').html('0900789789');function reservation_submit(){if(''==null||''==''){Notiflix.Loading.Hourglass('訂位處理中...');reservation_form_submit()}else if(''!=null&&''!=''){Notiflix.Loading.Hourglass('訂位處理中...');document.getElementById("reservation_form").action="/softwayliving/insert_bk/";document.getElementById("reservation_form").submit();}
