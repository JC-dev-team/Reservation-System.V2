;$('#displayName').html('aa'+'('+'James'+')');$('#displayPhone').html('0900123111');function reservation_submit(){if(''==null||''==''){Notiflix.Loading.Hourglass('訂位處理中...');reservation_form_submit()}else if(''!=null&&''!=''){Notiflix.Loading.Hourglass('訂位處理中...');document.getElementById("reservation_form").action="/softwayliving/insert_bk/";document.getElementById("reservation_form").submit();}
...
$(function(){$('#people_number_submit').click(function(e){console.log("weird001")
alert("jjss")
...
$('#button_submit').click(function(e){var status=true;alert("dd")
$('#store_id').val($('#store_name_select').val());$('#adult').val($('#adult_select').val())
