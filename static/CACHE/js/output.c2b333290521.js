...
$('#password_Modal').toggle()}},error:function(XMLHttpRequest,textStatus,errorThrown){Notiflix.Notify.Failure('發生未知錯誤！！');Notiflix.Loading.Remove();}})}
...
Notiflix.Loading.Hourglass('更新密碼中....');ajax_save_password(data)}},function(){$('#edit_Modal').toggle()
