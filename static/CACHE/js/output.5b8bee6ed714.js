...
if((adult_int+child_int>max_seat)&&'False'=='False'){Notiflix.Report.Warning('警告','人數不得超過'+max_seat+'人，如需預訂'+max_seat+'人以上，請電洽 02-2821-6659','ok');}else{if('False'=='False'){var reserve_limit=3}else{var reserve_limit=0}
