...
if(is_superuser=='True'){var auth='is_superuser'}else{var auth='is_admin'}
document.getElementById('edit_is_superuser').value=auth
if($('#edit_is_superuser').val()=='is_superuser'){$("option[name='auth_super']").attr('selected',true)
$("option[name='auth_not_super']").attr('selected',false)}else{$("option[name='auth_super']").attr('selected',false)
