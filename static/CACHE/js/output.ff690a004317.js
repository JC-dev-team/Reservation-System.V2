...
function save_edit(){Notiflix.Confirm.Show('管理者權限','確定要更動嗎?','是-儲存','否',function(){var staff_id=$('#edit_staff_id').val();var staff_name=$('#edit_staff_name').val();var staff_phone=$('#edit_staff_phone').val();var email=$('#edit_email').val();var data={'staff_id':staff_id,'staff_name':staff_name,'staff_phone':staff_phone,'email':email}
...
function edit_admin(t,staff_id,staff_name,staff_phone,email){document.getElementById('edit_Modal').style.display='inline'
...
function delete_admin(){var delete_staff_id=$('#edit_staff_id').val()
