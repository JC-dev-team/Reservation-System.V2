;$('#displayName').html(''+'('+''+')');$('#displayPhone').html('');function reservation_submit(){if(''==null||''==''){Notiflix.Loading.Hourglass('訂位處理中...');reservation_form_submit()}else if(''!=null&&''!=''){Notiflix.Loading.Hourglass('訂位處理中...');document.getElementById("reservation_form").action="/softwayliving/insert_bk/";document.getElementById("reservation_form").submit();}
...
if((adult_int+child_int>max_seat)&&''=='False'){Notiflix.Report.Warning('警告','人數不得超過'+max_seat+'人，如需預訂'+max_seat+'人以上，請電洽 02-2821-6659','ok');}else{var num=parseInt($('#date_num').val())
