...
$('#button_submit_test').click(function(e){Notiflix.Report.Failure('發生錯誤',"response.error",'ok');});$('#button_submit').click(function(e){var status=true;$('#store_id').val($('#store_name_select').val());$('#adult').val($('#adult_select').val())
