...
function edit_admin(t,staff_id,staff_name,staff_phone,email,password){document.getElementById('edit_Modal').style.display='inline'
...
var old_password=$('#old_password').val();var new_password=$('#new_password').val();var new_again_password=$('#new_again_password').val();if(new_password!=new_again_password){Notiflix.Report.Failure('錯誤','密碼與確認密碼不同','ok');status=false}
