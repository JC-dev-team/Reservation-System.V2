...
$('#button_submit').click(function(e){var status=true;Notiflix.Confirm.Show('訂位資訊','確定送出訂單','是','否',function(){reservation_submit()},function(){status=false;});$('#store_id').val($('#store_name_select').val());$('#adult').val($('#adult_select').val())
