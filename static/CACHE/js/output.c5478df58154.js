;$('#displayName').html('測試'+'('+'電話訂位'+')');$('#displayPhone').html('0900123123');function reservation_submit(){if('7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'==null||'7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'==''){Notiflix.Loading.Hourglass('訂位處理中...');reservation_form_submit()}else if('7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'!=null&&'7dd3e4d5-0ec7-11ea-b885-0ae1b9a16860'!=''){Notiflix.Loading.Hourglass('訂位處理中...');document.getElementById("reservation_form").action="/softwayliving/insert_bk/";document.getElementById("reservation_form").submit();}
...
function calendar_fun(result,num=0,reserve_limit){Notiflix.Loading.Remove();document.getElementById('calendar_container').style.display='inline'
