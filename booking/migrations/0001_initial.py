# Generated by Django 2.2.3 on 2019-09-29 03:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='booking.Store')),
            ],
            options={
                'db_table': 'staff',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='booking.Store')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='booking.Account')),
            ],
            options={
                'db_table': 'bk_list',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='booking.Staff')),
            ],
            options={
                'db_table': 'action_log',
            },
